...
template <class T1>
void	test_init_set(std::string message, int will_throw, T1 key_type)
{
	(void) key_type;
	try
	{
...
void	run_set_tests()
{
	...
	cc.x = 1;
	cc.y = 2;
	test_init_set("ft_set::<int>", 0, 0);
	test_init_set("ft_set::<double>", 0, 1.1);
	test_init_set("ft_set::<std::string>", 0, std::string("foo"));
	test_init_set("ft_set::<NULL>", 0, NULL);
	test_init_set("ft_set::<std::string>", 0, std::string("foo"));
	test_init_set("ft_set::<NULL>", 0, NULL);
	test_init_set("ft_set::<CustomClass>", 0, cc);
	test_init_set("ft_set::<CustomClass>", 0, cc);
	...
	test_line("*mine.begin()", *builtin.begin(), *mine.begin());
	test_line("mine.insert(2).second", builtin.insert(2).second, mine.insert(2).second);
	test_line("mine.insert(3).second", builtin.insert(3).second, mine.insert(3).second);
